...
\cvitem{Languages}{English - Native Speaker, JLPT N2 - Business-level proficiency}
\cvitem[11pt]{Front-End}{Javascript, Typescript, Next.js, React.js, Redux, Webpack, Node}
\cvitem[11pt]{Full-Stack}{AWS, Docker, Serverless, OpenShift, C\#, Java, Python, MySQL, PostgreSQL}
